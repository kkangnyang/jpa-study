...
import jpa.study.book.repository.MemberJpaRepository;
...
class MemberJpaRepositoryTest {
	 ...
	 * 트랜잭션 안에서 엔티티를 조회한 다음에 데이터를 변경하면, 트랜잭션 종료 시점에 변경감지
	 * 기능이 작동해서 변경된 엔티티를 감지하고 UPDATE SQL을 실행한다. 
	 */
	@Test
	void testEntity() {
	...
	public void basicCRUD() {
		Member member1 = new Member("member_basic1");
		Member member2 = new Member("member_basic2");
	...
	@Test
	void findByUsername() {
		memberJpaRepository.findByUsername("memberA").forEach(System.out::println);
	}
